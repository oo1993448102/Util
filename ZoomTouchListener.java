...
import com.hanyun.happyboat.AppManager;
import com.hanyun.happyboat.GlobalParams;
...
public class ZoomTouchListener implements OnTouchListener {
	...
	public ZoomTouchListener(ImageView imageView) {
	...
	public boolean onTouch(View v, MotionEvent event) {
		...
		case MotionEvent.ACTION_POINTER_DOWN:
			imageView.setScaleType(ScaleType.MATRIX); // 按下两指后可缩放、拖动
			isReturn = false;
			mode = MODE_ZOOM;
			/** 计算两个手指间的距离 */
	...
	private void big(){
		Bitmap bitmap = ((BitmapDrawable) ((ImageView) imageView).getDrawable()).getBitmap();
		 matrix.setScale(1.5f,1.5f,bitmap.getWidth()/2,bitmap.getHeight()/2); 
	}
